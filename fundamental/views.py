    ...
    def post(self, request):
        ...
        for item in calendar_data:
            try:
                ...
                event_time = timezone.make_aware(event_time_naive, timezone.get_current_timezone())
                ...
                return Response({'detail': f'Date parsing error: {str(e)}'}, status=status.HTTP_400_BAD_REQUEST)
