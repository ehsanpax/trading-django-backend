    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timeframe', models.CharField(choices=[('M1', '1 Minute'), ('M5', '5 Minutes'), ('M15', '15 Minutes'), ('M30', '30 Minutes'), ('H1', '1 Hour'), ('H4', '4 Hours'), ('D1', '1 Day')], default='M1', help_text='Chart timeframe for the backtest (e.g., M1, H1, D1)', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('strategy_name', models.CharField(default='', help_text="Name of the strategy from the registry, e.g., 'ema_crossover_v1'", max_length=255)),
                ('strategy_params', models.JSONField(default=dict, help_text='Parameters for the chosen strategy')),
                ('indicator_configs', models.JSONField(default=list, help_text="List of indicator configurations, e.g., [{'name': 'EMA', 'params': {'length': 20}}]")),
